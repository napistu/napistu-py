...
def test_add_edgelist_defaults():
    ...
    complete_edgelist = pd.DataFrame(
        {
            ...
            INTERACTION_EDGELIST_DEFS.UPSTREAM_SBO_TERM_NAME: ["catalyst", "catalyst"],
            INTERACTION_EDGELIST_DEFS.DOWNSTREAM_SBO_TERM_NAME: ["product", "product"],
    ...
    custom_defaults = {
        ...
        INTERACTION_EDGELIST_DEFS.UPSTREAM_SBO_TERM_NAME: "catalyst",
        INTERACTION_EDGELIST_DEFS.DOWNSTREAM_SBO_TERM_NAME: "product",
