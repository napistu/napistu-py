...
def test_resolve_matches_with_example_data():
    ...
    result_with_id = mount.resolve_matches(example_data, keep_id_col=True, numeric_agg=RESOLVE_MATCHES_AGGREGATORS.MEAN)
    ...
    result_without_id = mount.resolve_matches(example_data, keep_id_col=False, numeric_agg=RESOLVE_MATCHES_AGGREGATORS.MEAN)
    ...
    max_result = mount.resolve_matches(example_data, numeric_agg=RESOLVE_MATCHES_AGGREGATORS.MAX)
    ...
    weighted_result = mount.resolve_matches(example_data, numeric_agg=RESOLVE_MATCHES_AGGREGATORS.WEIGHTED_MEAN, keep_id_col=True)
    ...
    weighted_result_no_id = mount.resolve_matches(example_data, numeric_agg=RESOLVE_MATCHES_AGGREGATORS.WEIGHTED_MEAN, keep_id_col=False)
