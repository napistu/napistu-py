...
async def check_server_health(server_url: str = "http://127.0.0.1:8765") -> Optional[Dict[str, Any]]:
    """
...
async def list_server_resources(server_url: str = "http://127.0.0.1:8765") -> Optional[list]:
    """
...
async def read_server_resource(resource_uri: str, server_url: str = "http://127.0.0.1:8765") -> Optional[str]:
    """
