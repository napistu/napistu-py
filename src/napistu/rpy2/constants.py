...
BIOC_ONTOLOGY_MAPPING = {
    ONTOLOGIES.NCBI_ENTREZ_GENE: (BIOC_NOMENCLATURE.CHR_TBL, BIOC_NOMENCLATURE.NCBI_ENTREZ_GENE),
    ONTOLOGIES.ENSEMBL_GENE: (BIOC_NOMENCLATURE.ENSG_TBL, BIOC_NOMENCLATURE.ENSEMBL_GENE),
    ONTOLOGIES.ENSEMBL_TRANSCRIPT: (BIOC_NOMENCLATURE.ENST_TBL, BIOC_NOMENCLATURE.ENSEMBL_TRANSCRIPT),
    ONTOLOGIES.ENSEMBL_PROTEIN: (BIOC_NOMENCLATURE.ENSP_TBL, BIOC_NOMENCLATURE.ENSEMBL_PROTEIN),
