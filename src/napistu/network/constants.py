...
NAPISTU_GRAPH_EDGES = SimpleNamespace(
    ...
    SBO_NAME="sbo_name",
    UPSTREAM_SBO_TERM="upstream_sbo_term",
    DOWNSTREAM_SBO_TERM="downstream_sbo_term",
    SC_DEGREE="sc_degree",
...
EDGE_REVERSAL_ATTRIBUTE_MAPPING = {
    ...
    NAPISTU_GRAPH_EDGES.UPSTREAM_STOICHIOMETRY: NAPISTU_GRAPH_EDGES.DOWNSTREAM_STOICHIOMETRY,
    NAPISTU_GRAPH_EDGES.DOWNSTREAM_STOICHIOMETRY: NAPISTU_GRAPH_EDGES.UPSTREAM_STOICHIOMETRY,
    NAPISTU_GRAPH_EDGES.UPSTREAM_SBO_TERM: NAPISTU_GRAPH_EDGES.DOWNSTREAM_SBO_TERM,
    NAPISTU_GRAPH_EDGES.DOWNSTREAM_SBO_TERM: NAPISTU_GRAPH_EDGES.UPSTREAM_SBO_TERM,
